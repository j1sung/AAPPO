...
public class Learning_GameManager : GameManager
{
    // Player 객체 참조 변수
    ...
    void FixedUpdate()
    {
        ...
        if (resetTimer >= MaxEnvironmentSteps && MaxEnvironmentSteps > 0)
        {
            ...
            if(!human_score_change) human_Agent.AddReward(-5f);
